# Sprint 3.1: Front-end Mockup and Sprint 3.2: Data Visualization
...
- Flexibility in data display: We implemented the feature for the user to choose the display mode between: tabular, vertical columns, stacked vertical columns. The user can choose the display mode through a dropdown menu

- User Feedback for display: We chose to make the first columns as the x values and the other columns as y-values. The app will return a message telling the user which columns were not parsed becasue they were not numbers.
...
`Switching Datasets` : made sure that when switching from grapphs to table view all data is still viewed the same as ecpected. Only the relevant data in the chosen display mode is visible.
...
--------------------------------------------------------------------
# Sprint 3.2: Front-end Mockup

### Project Details
- Team: msteiu & saji
- Repo Link: https://github.com/cs0320-f24/mock-saji-msteiu.git
- Reflection for Sprint 3.2 is attached in a separate PDF file.
